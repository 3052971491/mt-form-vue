<template>
  <a-form-item class="event-handler-form-item" label="onChange">
    ...
    <event-handler-drawer
      ref="eventRef"
      v-model:value="options.onChange"
    >
      <template #header>
        <span v-if="!!element.formId">function onChange (element, newVal, oldVal) {</span>
        <span v-else>function onChange (newVal, oldVal) {</span>
      </template>
