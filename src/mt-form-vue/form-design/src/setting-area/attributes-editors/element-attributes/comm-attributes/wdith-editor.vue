<template>
  <a-form-item label="宽度" >
    ...
    <a-row>
      <a-col :span="17">
        <a-input v-model:value="options.width" placeholder="请输入" :maxlength="100" />
      </a-col>
      <a-col :span="7">
        <a-select v-model:value="options.widthUnit" placeholder="请输入" :options="selectOptions" style="width: 100% !important" />
      </a-col>
    </a-row>
  </a-input-group>
</a-form-item>
